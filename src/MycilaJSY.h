...
#define MYCILA_JSY_VERSION          "9.0.3"
#define MYCILA_JSY_VERSION_MAJOR    9
#define MYCILA_JSY_VERSION_MINOR    0
#define MYCILA_JSY_VERSION_REVISION 3
...
namespace Mycila {
  ...
  class JSY {
    public:
      ...
      float getResistance1() const { return _current1 == 0 ? 0 : _voltage1 / _current1; }
      float getResistance2() const { return _current2 == 0 ? 0 : _voltage2 / _current2; }
